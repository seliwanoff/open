  ...
  return (
    <div className='w-full px-6 py-10 font-sans bg-white overflow-x-hidden'>
      ...
      <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mt-10'>
        {datasets.map((d: any) => (
          <Link to={`/details/${d.id}`} key={d.id}>
            <div className='border border-[#3365e3] rounded-2xl p-5 shadow-sm hover:shadow-md transition bg-white flex flex-col cursor-pointer'>
